##############################################
# Investigate the "DNA methylation instability" metric in TCGA bulk samples.
# Updated: 2020.05.27
# Author: Kevin J.
##################################################
...
tcga_betas_epimut = readRDS("/Users/johnsk/Documents/Single-Cell-DNAmethylation/results/methylation/public/tcga_betas_bmiq_epimut_genes.rds")
## DNA methylation instability metric was calculated as the sum of the intermediate value
## over the the "high" epimutation genes.
eITH = readRDS("/Users/johnsk/Documents/Single-Cell-DNAmethylation/results/methylation/public/tcga_dna_methylation_instability.rds")
...
tcga_clinical = readWorkbook("/Users/johnsk/Documents/Single-Cell-DNAmethylation/data/ref/tcga-glioma-2016-clinical.xlsx", sheet = 1, startRow = 2, colNames = TRUE)
...
## How does the DNA methylation instability index vary by IDHmut status and DNAm subtype.
...
pdf(file = "/Users/johnsk/Documents/Single-Cell-DNAmethylation/results/methylation/public/tcga-subtype-high-epimut.pdf", height = 5, width = 10)
...
## Results from encode-normal-cell-types.R script 
encode_eITH <- read.table(file="/Users/johnsk/Documents/Single-Cell-DNAmethylation/results/methylation/public/encode-eITH-metrics.txt", sep="\t", header=T, stringsAsFactors = F)
...
my_comparisons <- list( c("Normal (ENCODE)", "Codel"), 
                        c("Normal (ENCODE)", "G-CIMP-high"), 
                        c("Normal (ENCODE)", "G-CIMP-low)"),
                        c("Normal (ENCODE)", "Classic-like"),
                        c("Normal (ENCODE)", "Mesenchymal-like"),
                        c("Normal (ENCODE)",  "LGm6-GBM"),
                        c("Normal (ENCODE)",  "PA-like" ))

pdf(file = "github/results/Fig7/Fig7b-tcga-subtype-encode-high-disorder-no-legend.pdf", height = 4, width = 6, useDingbats = FALSE, bg='transparent')
...
pdf(file = "github/results/Fig7/Fig7b-legend.pdf", height = 4, width = 6, useDingbats = FALSE, bg='transparent')
ggplot(tcga_clinical_filt_plot_encode, aes(x=`Supervised.DNA.Methylation.Cluster`, y=eITH, fill=Supervised.DNA.Methylation.Cluster)) + 
