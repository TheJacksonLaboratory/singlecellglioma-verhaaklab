# bam2epiallele.R - identifies concordant and discordant reads from an input BAM file generated by Bismark
...
readProportion <- data.frame(Sample=strsplit(basename(bam),".txt")[[1]],
                             ...
                             Discarded_Reads=dim(reads.discard)[1],
                             Discarded_Pct=signif((dim(reads.discard)[1]/totReads)*100,4),
